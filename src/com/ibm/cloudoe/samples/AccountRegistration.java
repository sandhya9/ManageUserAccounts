 ...
 */
@WebServlet("/AccountRegistration.do")
		...
		if (processVCAP(writer)) {
			...
			try {
				...
				sqlStatement = "CREATE TABLE " + tableName
						+ " (NAME VARCHAR(20), Github VARCHAR(20), GithubPASS VARCHAR(20), Twilio VARCHAR(20), TwilioPASS VARCHAR(20), Twitter VARCHAR(20), TwitterPASS VARCHAR(20), Dropbox VARCHAR(20), DropboxPASS VARCHAR(20))";
			...
			String acct1 =request.getParameter("acc1");
			String pwd1 =request.getParameter("pass1");
			
			String acct2 =request.getParameter("acc2");
			String pwd2 =request.getParameter("pass2");
			
			String acct3 =request.getParameter("acc3");
			String pwd3 =request.getParameter("pass3");
			
			String acct4 =request.getParameter("acc4");
			String pwd4 =request.getParameter("pass4");
			
			System.out.println("account 1------"+acct1+pwd1);
			System.out.println("account 2------"+acct2+pwd2);
			System.out.println("account 3------"+acct3+pwd3);
			System.out.println("account 4------"+acct4+pwd4);
			// Execute some SQL statements on the table: Insert, Select and Delete
			try {
				sqlStatement = "INSERT INTO " + tableName
						+ " VALUES ('"+ name+"','"+ acct1+"','"+ pwd1+"','"+ acct2+"','"+ pwd2+"','"+ acct3+"','"+ pwd3+"','"+ acct4+"','"+ pwd4+"')";
				writer.println("Executing: " + sqlStatement);
				stmt.executeUpdate(sqlStatement);
